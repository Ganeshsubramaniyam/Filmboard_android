...
import com.cozmoz.funraaga.VideoPlayer.ResizeSurfaceView;
import com.cozmoz.funraaga.VideoPlayer.VideoControllerView;

import java.io.IOException;

public class VideoPlayer_Activity extends AppCompatActivity implements SurfaceHolder.Callback, MediaPlayer.OnPreparedListener, VideoControllerView.MediaPlayerControlListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnCompletionListener {

    private final static String TAG = "VideoPlayer_Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        controller = new VideoControllerView.Builder(this, this)
                .withVideoTitle(this.VideoTitle)
        ...
        try {
            ...
            if(this.VideoURL.contains("storage") || this.VideoURL.contains("sdcard"))
            {
                mMediaPlayer.setDataSource(this, Uri.parse(this.VideoURL));
            }
            else
            {
                mMediaPlayer.setDataSource(this, Uri.parse("http://www.funraaga.in/Other%20Data/Video%20Songs/"+this.VideoURL+".mp4"));
            }
